...
# if else ladder here for game logic
    if choice==computer:
        ...
        '''
        if (choice==1  and computer==-1): # computer-choice=-2
            print("You win.Congrats!")
            win+=1
        elif(choice==1 and computer==0): # computer-choice=-1
            print("Computer wins")
            lose+=1
        elif(choice==-1 and computer==1): # computer-choice=2
            print("Computer win")
            lose+=1
        elif(choice==-1 and computer==0): # computer-choice=1
            print("You win.Congrats!")
            win+=1
        elif(choice==0 and computer==1): # computer-choice=1
            print("You win.Congrats")
            win+=1
        elif (choice==0 and computer==-1): # computer-choice=-1
            print("Computer win")
...
# we can shorten the game logic to just 4 lines here 
# like the game logic computer-choice gives a patttern 
# coputer wins when it is -1 or 2
        if ((computer-choice)==-1 or (computer-choice)==-2):
            ...
            print("You lose")
            lose-=1
# here shortes the code to just four lines
